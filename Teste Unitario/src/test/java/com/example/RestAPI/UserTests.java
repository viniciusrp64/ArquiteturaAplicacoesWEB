...
class UserTests {
    ...
    void testObterTodos() {
        List<UserEntity> userList = Arrays.asList(
                new UserEntity("1", "UserVinicius", "uservinicius@example.com"),
                new UserEntity("2", "UserTeste2", "user2@example.com")
        );
    ...
    void testObterPorId() {
        ...
        UserEntity user = new UserEntity("1", "UserVinicius",
                "uservinicius@example.com");
    ...
    void testInserir() {
        // Simular dados de usuário
        UserEntity newUser = new UserEntity("1", "UserVinicius",
                "uservinicius@example.com");
    ...
    void testAtualizar() {
        // Simular dados de usuário
        UserEntity updatedUser = new UserEntity("1", "UpdatedUserVinicius",
                "updateduservinicius@example.com");
